...
/**
 * react-hook-form primitives, shadcn-style. Wrap your form in `<Form>`,
 * then compose fields with `<FormField>` + `<FormItem>` + `<FormLabel>` +
 * `<FormControl>` + `<FormDescription>` + `<FormMessage>`.
 *
 * Keeps error rendering + aria wiring consistent across every form in
 * both apps.
 */
